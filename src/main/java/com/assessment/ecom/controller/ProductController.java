...
public class ProductController {
    ...
    //for updating sale by id
    @PutMapping("/sale/{id}")
    public ResponseEntity<Sale> updateSale(@PathVariable Long id, @RequestBody SaleDTO saleDTO) throws Exception {
        return ResponseEntity.ok(productService.updateSale(id,saleDTO));
    }

    //fetching revenue generated by each product
    ...
    //downloading per product details and revenue as pdf
